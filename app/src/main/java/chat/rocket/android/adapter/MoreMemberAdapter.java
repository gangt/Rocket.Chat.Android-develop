...
public class MoreMemberAdapter extends IndexableAdapter<UserEntity>  {
    ...
    public MoreMemberAdapter(Activity activity) {
        super();
    ...
    public RecyclerView.ViewHolder onCreateContentViewHolder(ViewGroup parent) {
        View view = mInflater.inflate(R.layout.more_member_item, parent, false);
    ...
    private class ContentVH extends RecyclerView.ViewHolder {
        TextView tvName,tv_dept;
        ImageView iv_online,iv_icon,iv_mute;
