...
public interface PublicSettingsConstants {
    ...
    interface Nest {
        String PAERSONL_NEST_ENABLE = "Personal_nest_enable";
        String MEETING_NEST_ENABLE = "Meeting_nest_enable";
        String LAYOUT_PERSON_TITLE="Layout_Person_Title";
        String LAYOUT_CHANNEL_TITLE="Layout_Channel_Title";
        String LAYOUT_MEETING_TITLE="Layout_Meeting_Title";
        String OWN_MEETING_TITLE="Own_Meeting_Title";
        String OTHER_MEETING_TITLE="Other_Meeting_Title";
        String LAYOUT_WORKING_SUPERVISE_COMPANY_TITLE="Layout_Working_Supervise_Company_Title";
        String LAYOUT_SUPERVISE_COMPANY_TITLE="Layout_Supervise_Company_Title";
    }
