...
object FrescoHelper {
    ...
    fun loadImageWithCustomization(draweeView: SimpleDraweeView, imageUri: String) {
        ...
        hierarchy.setPlaceholderImage(draweeView.resources.getDrawable(R.drawable.send_message_default))
        hierarchy.actualImageScaleType = ScalingUtils.ScaleType.FIT_CENTER
//        hierarchy.setPlaceholderImage(VectorDrawableCompat.create(draweeView.resources, R.drawable.send_message_default, null))
