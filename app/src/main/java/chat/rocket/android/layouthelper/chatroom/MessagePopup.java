...
public class MessagePopup {
    ...
    private static final Action CUNDANG_ACTION_INFO = new Action("归档", null, true);
...
//                            EDIT_ACTION_INFO.allowed = pair.second;
                            ...
                            CUNDANG_ACTION_INFO.allowed=(!(message.getMessage().contains(hostname)&&message.getMessage().contains("?msg="))&&pair.first.getAttachments()!=null)?true:false;
...
//                                    .setTitle("Message")
    ...
    private void addDefaultActions() {
        ...
        singleton.defaultActions.add(CUNDANG_ACTION_INFO);
...
//    }
    ...
    public MessagePopup setRelayAction(ActionListener actionListener) {
        RELAY_ACTION_INFO.actionListener = actionListener;
        return singleton;
    }

    public MessagePopup setCundangAction(ActionListener actionListener) {
        CUNDANG_ACTION_INFO.actionListener = actionListener;
        return singleton;
    }
