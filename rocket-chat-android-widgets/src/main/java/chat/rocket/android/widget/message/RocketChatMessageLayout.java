...
//    String content = Emojione.shortnameToUnicode(text, false);
    String content = text;

    SpannableString mContent = SpanStringUtils.getEmotionContent(EmotionUtils.EMOTION_CLASSIC_TYPE, getContext(), textView, content);
