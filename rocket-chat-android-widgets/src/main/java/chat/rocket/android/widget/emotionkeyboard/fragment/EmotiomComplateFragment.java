package chat.rocket.android.widget.emotionkeyboard.fragment;
...
import chat.rocket.android.widget.emotionkeyboard.adapter.EmotionGridViewAdapter;
import chat.rocket.android.widget.emotionkeyboard.adapter.EmotionPagerAdapter;
import chat.rocket.android.widget.emotionkeyboard.emotionkeyboardview.EmojiIndicatorView;
...
public class EmotiomComplateFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        // 动态计算item的宽度和高度
        int itemWidth = (screenWidth - spacing * 9) / 8;
        //动态计算gridview的总高度
        ...
        // 遍历所有的表情的key
        for (String emojiName : EmotionUtils._shortNameToUnicodes) {
...
//        for (String emojiName : Emojione._shortNameToUnicodes) {
//            emotionNames.add(emojiName);
//            // 每20个表情作为一组,同时添加到ViewPager对应的view集合中
