...
public class InputHostnameFragment extends AbstractFragment implements InputHostnameContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new InputHostnamePresenter(ChatConnectivityManager.getInstance(appContext));
        presenter.connectTo(getString(R.string.fragment_input_hostname_server_hint));
    }
