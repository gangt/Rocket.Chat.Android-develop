 ...
 * "userData" subscriber.
 */
public class RelationUserDataSubscriber extends AbstractBaseSubscriber {
  public RelationUserDataSubscriber(Context context, String hostname, RealmHelper realmHelper) {
    super(context, hostname, realmHelper);
  }

  @Override
  protected String getSubscriptionName() {
    return "relationUserData";
  }
